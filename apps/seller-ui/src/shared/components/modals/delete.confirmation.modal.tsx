    ...
    <div className='fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center  justify-center'>
        <div className='bg-gray-800 p-6 rounded-lg md:w-[450px] shadow-lg'>
            ...
            <div className='flex justify-between items-center border-b border-gray-700 pb-2'>
                <h3 className='text-left text-white'>Delete Product</h3>
            ...
            <p className='text-gray-300 mt-4'>
                ...
                <br />
                This product will be moved to <span className='font-semibold text-red-500'>DELETE</span> state and permanently
