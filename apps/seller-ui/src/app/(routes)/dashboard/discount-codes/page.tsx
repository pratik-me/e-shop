  ...
  return (
    <div className="w-full min-h-screen p-8">
      ...
      <div className="flex items-center text-white">
        <Link href={"/dashoboard"} className="text-[#80Deea] cursor-pointer">
          Dashoboard
        </Link>
                  ...
                  render={({ field }) => (
                    <div className="relative" ref={dropdownRef}>
                      <div
                        ...
                        className="w-full border border-gray-700 bg-transparent text-white p-2 rounded-md cursor-pointer flex justify-between items-center"
                      >
                        <span>
                      ...
                      {isOpen && (
                        <div className="absolute z-10 w-full mt-1 bg-[#18181b] border border-gray-700 rounded-md shadow-lg p-1">
                          {options.map((option) => {
                            ...
                            return (
                              <div
                                ...
                                className={`flex items-center px-2 py-2 cursor-pointer rounded-md text-sm transition-colors pl-4 ${
                                  isSelected
